...
**Solo founder & CTO, [SFX Tech Innovation](https://sfxtechinnovation.com).** I build agentic systems, custom software, and AI agents, end to end.
...
- **[CullPilot](https://github.com/SFX-TECH/cullpilot):** local AI photo culling for photographers. Score, group, and rank an 8,000-photo shoot on your own GPU; clients' photos never leave the machine. *(pre-launch)*

## 🧠 AI tooling
- **[SFX Lead Intelligence Command Center](https://github.com/SFX-TECH/sfx-lead-intelligence):** a local-LLM command center. A semantic hub over 16 projects (30k+ chunks) with a knowledge graph and an MCP server, plus a lead dashboard with 9 AI routes. Quality lifted 61% to 99% by a ground-truth eval harness.
- **[Local Transcriber](https://github.com/SFX-TECH/local-transcriber):** any-length Whisper transcription on your own machine. No cloud, no cap, no paywall.
...
- **Multi-vertical lead generation** across 40+ Southwest-Florida verticals: scrape, Claude scoring, outreach, plus a client-discovery pipeline that briefs a prospect on demand.
